...
/**
 * This is the AttackAction class
 */
public class AttackAction extends MoveAttackAction {
     ...
     */
    public AttackAction(int num, String source, String destination, String name, String unitName, Action next) {
     ...
     * This is the constructor of the class
     *
     * @param attackInfo is the attackInfo map that specifies this action
     ...
     * @param next is a pointer to the next action
     */
    public AttackAction(Map<String, Integer> attackInfo, String source, String destination, String name, Action next) {
        super(attackInfo, source, destination, name, next);
    }
